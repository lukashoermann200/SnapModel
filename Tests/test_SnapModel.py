...
from BADASS.RDFRun import RDFRun
from aimstools.GeometryFile import GeometryFile

from SnapModel.SnapModel import EnergyModelML, EnergyModelLJ, SnapModel, getInitialValuesForPhiAndTheta
...
class TestSnapModel(unittest.TestCase):
    ...
    def test_ThermalActivation(self):
        ...
        R = ut.getCartesianRotationMatrix(angle * np.pi / 180, get_3x3_matrix=True)
        ...
        df_TA, Ediss_TA = snap_model_TA.runOscillation(f0, NSteps, apex_height, th, phi)
        
        
        snap_model = SnapModel(geom,
                               tip,
                               osc_center + horizontal_offset*osc_dir_0,
                               osc_dir,
                               asc_amp,
